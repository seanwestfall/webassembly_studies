...
var real_dynCall_viiiddd = asm["dynCall_viiiddd"];
asm["dynCall_viiiddd"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viiiddd.apply(null, arguments);
};

var real_dynCall_iiiiddd = asm["dynCall_iiiiddd"];
asm["dynCall_iiiiddd"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iiiiddd.apply(null, arguments);
};
